...
function _ar18__string__format__percentage(){


  function ar18__string__format__percentage(){
    local str="$1"
    local fill_char=" "
    set +u
    local length="$2"
...
type ar18__string__format__percentage > /dev/null || _ar18__string__format__percentage
